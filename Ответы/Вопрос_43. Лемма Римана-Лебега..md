...
$$ \int_{a}^{b} c e^{i\lambda x} \, dx = c \left( \int_{a}^{b} \cos \lambda x \, dx + i \int_{a}^{b} \sin \lambda x \, dx \right) = c \left( \frac{\sin \lambda b - \sin \lambda a}{\lambda} - i \frac{\cos \lambda b - \cos \lambda a}{\lambda} \right) $$
...
$$ \left| \int_{a}^{b} f(x)e^{i\lambda x} \, dx - \int_{\delta_1}^{\delta_2} f(x)e^{i\lambda x} \, dx \right| \leq \int_{a}^{\delta_1} |f(x)| \, dx + \int_{\delta_2}^{b} |f(x)| \, dx < \frac{\varepsilon}{4} + \frac{\varepsilon}{4} = \frac{2\varepsilon}{4} $$
...
$$ \left| \int_{\delta_1}^{\delta_2} f(x)e^{i\lambda x} \, dx - \int_{\delta_1}^{\delta_2} g(x)e^{i\lambda x} \, dx \right| \leq \int_{\delta_1}^{\delta_2} |f(x) - g(x)| \cdot |e^{i\lambda x}| \, dx = 
$$
$$
...
$$ \left| \int_{a}^{b} f(x)e^{i\lambda x} \, dx \right| \leq \left| \int_{a}^{b} f(x)e^{i\lambda x} \, dx - \int_{\delta_1}^{\delta_2} f(x)e^{i\lambda x} \, dx \right| + \left| \int_{\delta_1}^{\delta_2} f(x)e^{i\lambda x} \, dx - \int_{\delta_1}^{\delta_2} g(x)e^{i\lambda x} \, dx \right| + \left| \int_{\delta_1}^{\delta_2} g(x)e^{i\lambda x} \, dx \right| $$
